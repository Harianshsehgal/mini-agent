"""Step 05 — agent stage 2: tool errors go to the model as text.

4.4.2: adds ToolErrorMiddleware, like the errors-as-text in 04-react-agent.
"""
...
if __name__ == "__main__":
    ...
    run("What's the weather in the city where Big Ben is?")
    run( "What's the weather where the Taj is?")